    ...
    <div className="min-h-screen flex bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center p-8 sm:p-12 lg:p-16 xl:p-24 relative">
        <div className="max-w-md mx-auto w-full">
          ...
          >
            <h1 className="text-3xl sm:text-4xl font-bold text-slate-900 dark:text-white mb-2">Chào mừng trở lại</h1>
            <p className="text-slate-500 dark:text-slate-400 mb-8">Nhập thông tin của bạn để truy cập tài khoản.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between items-center">
                  ...
                  <Link to="#" className="text-xs font-medium text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300">
                    Quên mật khẩu?
                  </Link>
                </div>
                <div className="relative">
              ...
              {error && (
                <motion.div 
                  ...
                  className="p-3 rounded-lg bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 text-sm border border-red-100 dark:border-red-900"
                >
                  {error}
                </motion.div>
              )}
            ...
            <div className="mt-8">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-white dark:bg-slate-950 text-slate-500 dark:text-slate-400">Hoặc tiếp tục với</span>
                </div>
              </div>

              <div className="mt-6 grid grid-cols-2 gap-3">
                <button type="button" className="flex items-center justify-center gap-2 px-4 py-3 border border-slate-200 dark:border-slate-800 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-900 transition-colors">
            ...
            <p className="mt-8 text-center text-sm text-slate-600 dark:text-slate-400">
              Chưa có tài khoản?{' '}
              <Link to="/register" className="font-semibold text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300 hover:underline">
                Đăng ký miễn phí
              </Link>
            </p>
          </motion.div>
