const en = {
  ...
  checkout: {
    ...
    created: "Order placed successfully! You can track it from My Orders.",
    ...
    redirectingPayment: "Your order has been created. Redirecting to payment...",
    qrReady: "Your order has been created. Scan the QR code to complete payment.",
  ...
  admin: {
    ...
    categoriesEyebrow: "Create and organize the bookstore categories",
    categoryTree: "Category tree",
    categoryFormHelp: "Enter the category details. Choose a parent only for a subcategory.",
    newCategory: "New category",
    ...
    validationCategoryName: "Category name must contain between 2 and 150 characters.",
    validationCategoryDescription: "Description is required and must not exceed 1,000 characters.",
    validationCategorySlug: "Slug must not exceed 150 characters.",
    validationCategoryImageUrl: "Image URL must not exceed 255 characters.",
    ...
    errors: {
      ...
      categorySave: "Could not save the category. Please review the entered information.",
